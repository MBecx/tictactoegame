...
public class Game {
    ...
    public boolean doChecks() {
        ...
        String winnerMessage = checkGameWinner(grid,turn,freeSpots);
     ...
     */
    public String checkGameWinner(char [][]grid, char turn, int freeSpots){
        String result = "None";
        ...
        //checkDiagonal
        if ((grid[0][0] == turn && grid[1][1] == turn && grid[2][2] == turn) || (grid[0][2] == turn && grid[1][1] == turn && grid[2][0] == turn))
            result = turn + " wins";
